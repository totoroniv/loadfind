...
public class LoadFindRecommendationService  {
    ...
    @Value("${load-find.recommendation.base.url}")
    private String baseUrl;


    public List<OutputDto> recommendationLoadFindList(String address) {

        KakaoApiResponseDto kakaoApiResponseDto = kakaoAddressSearchService.requestAddressSearch(address);

        if (Objects.isNull(kakaoApiResponseDto) || CollectionUtils.isEmpty(kakaoApiResponseDto.getDocumentList())) {
            log.error("[LoadFindRecommendationService recommendLoadFindList fail] Input address: {}", address);
    ...
    private OutputDto convertToOutputDto(Direction direction) {
        ...
        return OutputDto.builder()
                .loadFindName(direction.getTargetLoadName())
                .loadFindAddress(direction.getTargetAddress())
